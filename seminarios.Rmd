...
-   [Estadística bayesiana: principios, teorema de bayes y su aplicación](https://www.youtube.com/watch?v=usB7reMJxLU)
...
-   [Análisis de la ciencia ciudadana mediante modelos de ocupación](https://www.youtube.com/watch?v=OKEtldANpHA)
...
-   [Generación de visores de datos espaciales con R](https://www.youtube.com/watch?v=niPkyIrEv-k)
...
-   [Análisis de dinámicas poblacionales en R](https://www.youtube.com/watch?v=oAC7DVWAMRc)
...
-   [Integración de datos en la estima de la distribución y abundancia animal](https://www.youtube.com/watch?v=ybD4GM_OB3M)
...
-   [Introducción a Zotero: cómo organizar nuestras referencias de forma accesible y cómo citar fácilmente en R con Quarto/RMarkdown](https://www.youtube.com/watch?v=nkEM6ny_E9U)
...
-   [Introducción al uso de filogenias en Ecología. El paquete randtip como método de abordar la incompletitud filogenética](https://www.youtube.com/watch?v=C9Gyah5XES0)
...
-   [Regímenes dinámicos ecológicos: identificación, caracterización y comparación](https://www.youtube.com/watch?v=Fy5YNSe-btA)
...
-   [Taller de labeleR: cómo generar etiquetas científicas, certificados para eventos y mucho más en R](https://www.youtube.com/watch?v=CPimYLdDI5o)
...
-   [¿Qué información puedo obtener de los datos abiertos PNOA-LiDAR para caracterizar mi zona de estudio?](https://www.youtube.com/watch?v=vzjqLjKOPPM)
...
-   [Inferencias de rango a partir de la distribución geográfica de la diversidad genética de las especies](https://www.youtube.com/watch?v=KLN2wMnivVA)
...
-   [El papel de la IA en la ecología, cómo transformar imágenes en datos: Opciones, desafíos y soluciones](https://www.youtube.com/watch?v=txJfuPeodQw)
...
## Seminario 17. BlueCarbon R package: get carbon stocks and sequestration rates

-   [BlueCarbon R package: get stocks and sequestration rates estimations directly from raw laboratory data](https://www.youtube.com/watch?v=XCrrR3_MSHc)
