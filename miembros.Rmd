...
## Get picture from twitter profile
# https://stackoverflow.com/a/62263395
datos <- datos %>%
  mutate(Photo = paste0("<img src='https://unavatar.now.sh/twitter/", Twitter, "' height='60' width='60'></img>")) %>%
  mutate(Photo = ifelse(is.na(Twitter), NA, Photo))
