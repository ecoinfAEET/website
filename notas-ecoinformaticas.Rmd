...
Idealmente las notas deber dar una visión general para ecólogos no especialistas en ecoinformática. Más que un tratado exhaustivo, se recomienda el uso de ejemplos (es decir, mostrando código) y referencias a la literatura o tutoriales especializados para quien quiera saber más. En caso de incluir código de R, éste debe seguir las normas de estilo especificadas [aquí](http://adv-r.had.co.nz/Style.html).
